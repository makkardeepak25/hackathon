...
function Card({item}) {
    const {id,school_name,email,annual_fee,address,city,teacher_to_student_ratio,school_image}=item
    ...
    return (
        <div className={Styles.cardMain1}>
            <div className={Styles.cardflex}>
                <img className={Styles.cardImage} src={school_image} alt="" />
            </div>
            <div className={Styles.cardflex1}>
                ...
                <p className={Styles.subName1}>Adress: {address}</p>
                    ...
                    <div className={Styles.subDiv2}>
                        ...
                        <h3> Ratio: {teacher_to_student_ratio} students</h3>
